...
<html>
    ...
    <body style="color:#777">
        ...
        <div class="container" style="margin-top: 20px;">
            ...
            <div class="container" style="margin-top: 20px;background: url('/img/guaranteebg.png') repeat-x 0 0;color: #444;">
                ...
                <!--div>
                    <h5>
                        ...
                        <p>*** при подаче заявления стороны расторгают ранее заключенный договор, подписывая соответсвующие акты.
            ...
            <div class="container" style="margin-top: 20px;">
                <h3>Позвоните сейчас по телефону +7(342)259-56-57 и узнайте, сколько денег вы заработаете с помощью Диалога</h3>
            </div>    
            ...
            <div class="container" style="margin-top: 20px;">
                ...
                <div class="container" style="margin-top: 20px;">
                    ...
                    <div class="saletoggle collapse col-lg-12" style="border-bottom: 1px solid #eee;">
                        <ul>
                            <li><h3>Упомяните* нас на http://vk.com и получите скидку в размере 5% от стоимости вашего договора</h3></li>
                            <li><h3>Упомяните нас на https://www.facebook.com и получите скидку в размере 5% от стоимости вашего договора</h3></li>
                            <li><h3>Укажите нас на сайте Вашей компании в качестве партнера и получите скидку в размере 5% от стоимости вашего договора</h3></li>
                    ...
                    <div class="saletoggle collapse col-lg-12" style=""><h5>
