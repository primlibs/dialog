            ...
            <table class="table table-bordered table-hover">
                ...
                <c:forEach var="t" items="${tarifs}" varStatus="myIndex">
                    <tr>
                        ...
                        <td> ${t.clientCount} </td>
                        <td><c:if test="${!t.isDefault()}"><form action="<c:url value="/Tarif/setDefault"/>" method="post">
                                    <input type="hidden" name="tarifId" value="${t.tarifId}">
                                    <input class="btn btn-warning btn-xs" type="submit" value="По умолчанию">
                                </form></c:if>
